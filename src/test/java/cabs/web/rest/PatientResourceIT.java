...
class PatientResourceIT {
    ...
    public static Patient createEntity(EntityManager em) {
        Patient patient = new Patient().name(DEFAULT_NAME).email(DEFAULT_EMAIL).phone_number(DEFAULT_PHONE_NUMBER);
        return patient;
    }
    ...
    public static Patient createUpdatedEntity(EntityManager em) {
        Patient patient = new Patient().name(UPDATED_NAME).email(UPDATED_EMAIL).phone_number(UPDATED_PHONE_NUMBER);
        return patient;
    }
    ...
    void createPatient() throws Exception {
        ...
        assertThat(testPatient.getPhone_number()).isEqualTo(DEFAULT_PHONE_NUMBER);
    }
    ...
    void putExistingPatient() throws Exception {
        ...
        updatedPatient.name(UPDATED_NAME).email(UPDATED_EMAIL).phone_number(UPDATED_PHONE_NUMBER);
        ...
        assertThat(testPatient.getPhone_number()).isEqualTo(UPDATED_PHONE_NUMBER);
    }
    ...
    void partialUpdatePatientWithPatch() throws Exception {
        ...
        partialUpdatedPatient.name(UPDATED_NAME).phone_number(UPDATED_PHONE_NUMBER);
    ...
    void fullUpdatePatientWithPatch() throws Exception {
        ...
        partialUpdatedPatient.name(UPDATED_NAME).email(UPDATED_EMAIL).phone_number(UPDATED_PHONE_NUMBER);
